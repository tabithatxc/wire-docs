...
let
  ...
  overrides = manylinux1: autoPatchelfHook: merge_with_overr false (python-self: python-super: let self = {
    ...
    "setuptools-scm" = python-self.buildPythonPackage {
      pname = "setuptools-scm";
      version = "4.1.2";
      src = fetchPypiWheel "setuptools-scm" "4.1.2" "setuptools_scm-4.1.2-py2.py3-none-any.whl";
      format = "wheel";
      dontStrip = true;
      passthru = (get_passthru "setuptools-scm" "setuptools_scm") // { provider = "wheel"; };
    ...
    "sphinxcontrib-redoc" = python-self.buildPythonPackage {
      pname = "sphinxcontrib-redoc";
      version = "1.6.0";
      src = fetchPypi "sphinxcontrib-redoc" "1.6.0";
      passthru = (get_passthru "sphinxcontrib-redoc" "sphinxcontrib-redoc") // { provider = "sdist"; };
      buildInputs = with python-self; [ setuptools-scm ];
      propagatedBuildInputs = with python-self; [ jinja2 jsonschema pyyaml six sphinx ];
    };
